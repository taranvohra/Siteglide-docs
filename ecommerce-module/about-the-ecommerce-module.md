...
{% content-ref url="../eCommerce/payment-gateways/introduction.md" %}
[introduction.md](../eCommerce/payment-gateways/introduction.md)
{% endcontent-ref %}
...
{% content-ref url="../eCommerce/basic-payments/basic-payments.md" %}
[basic-payments.md](../eCommerce/basic-payments/basic-payments.md)
{% endcontent-ref %}
