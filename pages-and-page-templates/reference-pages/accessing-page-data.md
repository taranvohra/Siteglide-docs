...
[alternatives-to-storing-server-side-code-in-fields.md](../../webapps-databases/go-further-webapps/front-end-submit-forms-edit/alternatives-to-storing-server-side-code-in-fields.md "mention")
