...
* [Setup CLI](siteglide-cli/setup-cli/README.md)
  * [💡 About Siteglide CLI](siteglide-cli/setup-cli/introduction.md)
  * [📋 Steps to Install Siteglide CLI](siteglide-cli/setup-cli/getting-started-with-cli.md)
  * [📋 Steps to Set Up Siteglide CLI on a Specific Site](siteglide-cli/setup-cli/steps-to-set-up-siteglide-cli-on-a-specific-site.md)
* [Using CLI](siteglide-cli/using-cli/README.md)
  * [👀 Siteglide CLI Reference & Commands](siteglide-cli/using-cli/siteglide-cli-reference.md)
  * [🔧 Troubleshooting Siteglide CLI](siteglide-cli/using-cli/troubleshooting-siteglide-cli.md)
  * [🧞 SiteBuilder with Siteglide CLI](siteglide-cli/using-cli/sitebuilder-with-siteglide-cli.md)
  * [🔼 Siteglide CLI Migrate Command](siteglide-cli/using-cli/siteglide-cli-migrate-command/README.md)
    * [🔼 Siteglide CLI Migrate Command - Manual Forms](siteglide-cli/using-cli/siteglide-cli-migrate-command/cli-migrate-command-manual-forms.md)
    * [🔼 Siteglide CLI Migrate Command - Converting Forms](siteglide-cli/using-cli/siteglide-cli-migrate-command/cli-migrate-command-converting-forms.md)
...
* [📂 Payment Gateways](eCommerce/payment-gateways/introduction.md)
  ...
  * [🔹 Test Cards](ecommerce-module/introduction/test-cards.md)
  * [📋 Steps to Switching Payment Gateway](eCommerce/payment-gateways/switching-gateway.md)
  * [💻 Building a Custom Payment Gateway](ecommerce-module/introduction/building-a-custom-payment-gateway/README.md)
    * [📋 Steps to Support Basic Payment Forms with your Custom Payment Gateway](ecommerce-module/introduction/building-a-custom-payment-gateway/steps-to-support-basic-payment-forms-with-your-custom-payment-gateway.md)
    * [📋 Steps to Support Checkout with your Custom Payment Gateway](ecommerce-module/introduction/building-a-custom-payment-gateway/steps-to-support-checkout-with-your-custom-payment-gateway.md)
...
* [📂 Basic Payments](eCommerce/basic-payments/introduction.md)
  ...
  * [🌳 Basic Payment Forms Folder Structure](ecommerce-module/introduction-1/basic-payment-forms-folder-structure.md)
  * [👀 Basic Payment Forms Reference](eCommerce/basic-payments/ecommerce-basic-payment.md)
  * [📋 Steps to Set up a Basic Payment Form (with a Fixed Payment Amount)](ecommerce-module/introduction-1/steps-to-set-up-a-basic-payment-form-with-a-fixed-payment-amount.md)
  * [📋 Authorize.net Basic Payment Forms](ecommerce-module/introduction-1/authorize.net-basic-payment-forms.md)
  * [📋 PayPal Basic Payment Forms](ecommerce-module/introduction-1/paypal-basic-payment-forms.md)
  * [📋 Steps to Allow User to Decide Amount they Will Pay](ecommerce-module/introduction-1/steps-to-allow-user-to-decide-amount-they-will-pay.md)
...
* [📂 Cart, Checkout and Quotes](eCommerce/cart-checkout-or-quotes/introduction.md)
  ...
  * [👀 Product List and Detail Layout Reference](eCommerce/cart-checkout-or-quotes/product-liquid-reference.md)
  * [👀 Cart Layouts Reference](eCommerce/cart-checkout-or-quotes/cart-layouts.md)
  * [👀 Checkout Reference](eCommerce/cart-checkout-or-quotes/ecommerce-checkout-standard.md)
