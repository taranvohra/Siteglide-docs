...
A new version of the `tailwind.min.css` file will be generated. Use the Siteglide CLI to sync or deploy this to your Site to see your changes applied: [siteglide-cli-reference.md](../../siteglide-cli/using-cli/siteglide-cli-reference.md "mention")\
\
