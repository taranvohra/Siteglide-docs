...
{% content-ref url="../siteglide-modules-marketplace/modules-folder-structure-introduction.md" %}
[modules-folder-structure-introduction.md](../siteglide-modules-marketplace/modules-folder-structure-introduction.md)
{% endcontent-ref %}
